...
$(document).ready(function() {
    if ($(".usertable").length > 0) {
        ...
        t.columnFilter({sPlaceHolder: "head:after", sRangeFormat: "{from}{to}", aoColumns: [ {type: "text"}, {type: "text"}, {type: "select", bCaseSensitive: !0, values: ["Active", "Inactive"]}, {type: "date-range"}, null]});
    ...
    if ($("#simg").length > 0) {
        function _(e) {
            return e.id ? "<img style='padding-right:10px;' src='../../assets/img/demo/flags/" + e.id.toLowerCase() + ".gif'/>" + e.text : e.text
        }
