...
function icheck() {
    $(".icheck-me").length > 0 && $(".icheck-me").each(function() {
        var e = $(this), t = e.attr("data-skin") !== undefined ? "_" + e.attr("data-skin") : "", n = e.attr("data-color") !== undefined ? "-" + e.attr("data-color") : "", r = {checkboxClass: "icheckbox" + t + n, radioClass: "iradio" + t + n, increaseArea: "10%"};
        e.iCheck(r)
    })
}
...
(function(e) {
    e.fn.retina = function(t) {
        var n = {retina_part: "-2x"};
        t && jQuery.extend(n, {retina_part: t});
        window.devicePixelRatio >= 2 && this.each(function(t, r) {
            ...
            e.ajax({url: s, type: "HEAD", success: function() {
                    e(r).attr("src", s)
                }})
        });
        return this
...
$(document).ready(function() {
    ...
    $(".chart").length > 0 && $(".chart").each(function() {
        var e = "#881302", t = $(this), n = t.attr("data-trackcolor");
        ...
        t.easyPieChart({animate: 1e3, barColor: e, lineWidth: 5, size: 80, lineCap: "square", trackColor: n})
    });
    if ($(".calendar").length > 0) {
        $(".calendar").fullCalendar({header: {left: "", center: "prev,title,next", right: "month,agendaWeek,agendaDay,today"}, buttonText: {today: "Today"}, editable: !0});
    ...
    $(".notify").click(function() {
        var e = $(this), t = e.attr("data-notify-title"), n = e.attr("data-notify-message"), r = e.attr("data-notify-time"), i = e.attr("data-notify-sticky"), s = e.attr("data-notify-overlay");
        $.gritter.add({title: typeof t != "undefined" ? t : "Message - Head", text: typeof n != "undefined" ? n : "Body", image: typeof image != "undefined" ? image : null, sticky: typeof i != "undefined" ? i : !1, time: typeof r != "undefined" ? r : 3e3})
    });
    ...
    $(".chosen-select").length > 0 && $(".chosen-select").each(function() {
        var e = $(this), t = e.attr("data-nosearch") === "true" ? !0 : !1, n = {};
    ...
    $(".filetree").length > 0 && $(".filetree").each(function() {
        ...
        if (e.hasClass("filetree-checkboxes")) {
            ...
            t.onSelect = function(e, t) {
                var n = t.tree.getSelectedNodes(), r = $.map(n, function(e) {
    ...
    $(".plupload").length > 0 && $(".plupload").each(function() {
        var e = $(this);
        e.pluploadQueue({runtimes: "html5,gears,flash,silverlight,browserplus", url: "js/plupload/upload.php", max_file_size: "10mb", chunk_size: "1mb", unique_names: !0, resize: {width: 320, height: 240, quality: 90}, filters: [{title: "Image files", extensions: "jpg,gif,png"}, {title: "Zip files", extensions: "zip"}], flash_swf_url: "js/plupload/plupload.flash.swf", silverlight_xap_url: "js/plupload/plupload.silverlight.xap"});
    ...
    $(".form-wizard").length > 0 && $(".form-wizard").formwizard({formPluginEnabled: !0, validationEnabled: !0, focusFirstInput: !1, disableUIStyles: !0, validationOptions: {errorElement: "span", errorClass: "help-block error", errorPlacement: function(e, t) {
            ...
            }}, formOptions: {success: function(e) {
                alert("Response: \n\n" + e.say)
    ...
    $(".dataTable").length > 0 && $(".dataTable").each(function() {
        if (!$(this).hasClass("dataTable-custom")) {
            var e = {sPaginationType: "full_numbers", oLanguage: {sSearch: "<span>Search:</span> ", sInfo: "Showing <span>_START_</span> to <span>_END_</span> of <span>_TOTAL_</span> entries", sLengthMenu: "_MENU_ <span>entries per page</span>"}, sDom: "lfrtip"};
            ...
            if ($(this).hasClass("dataTable-colvis")) {
                e.sDom = "C" + e.sDom;
                e.oColVis = {buttonText: "Change columns <i class='icon-angle-down'></i>"}
            }
            if ($(this).hasClass("dataTable-tools")) {
                e.sDom = "T" + e.sDom;
                e.oTableTools = {sSwfPath: "../../assets/js/plugins/datatable/swf/copy_csv_xls_pdf.swf"}
            }
            ...
            $(this).hasClass("dataTable-columnfilter") && r.columnFilter({sPlaceHolder: "head:after"});
    ...
    resize_chosen();
    $(".file-manager").length > 0 && $(".file-manager").elfinder({url: "js/plugins/elfinder/php/connector.php"});
    ...
    $(".ckeditor").length > 0 && CKEDITOR.replace($(".ckeditor").attr('name'));  /** Modify 7$ **/
