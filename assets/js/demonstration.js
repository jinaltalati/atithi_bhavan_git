...
$(document).ready(function() {
	...
	if($(".usertable").length > 0){
		var opt = {
			...
			'oTableTools' : {
				"sSwfPath": "../../assets/js/plugins/datatable/swf/copy_csv_xls_pdf.swf"
			}
		};
...
if($("#simg").length > 0){
	function formatFlags(state){
		...
		return "<img style='padding-right:10px;' src='../../assets/img/demo/flags/" + state.id.toLowerCase() + ".gif'/>" + state.text;
	}
	$("#simg").select2({
