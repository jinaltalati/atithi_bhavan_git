                    ...
                    <div class="tab-pane active" id="profile">
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span6">
                             ...
                             <div class="span6">
                                ...
                                <div class="control-group">
                                    ...
                                    <!-- <div class="controls"> -->
                                        <input type="text" name="data[room_name]" id="room_name" class='form-control'  data-rule-required="true" placeholder="Room Name" value="<?php echo (isset($data['room_name']))?$data['room_name']:'';?>" required="required">
                                    <!-- </div> -->
                                </div>   
                            ...
                            <div class="span6">
                                <div class="control-group">
                                    ...
                                    <!-- <div class="controls"> -->
                                        <input type="text" name="data[capacity]" id="capacity" class='form-control'  data-rule-required="true" placeholder="Room Capacity" value="<?php echo (isset($data['room_name']))?$data['capacity']:'';?>" required="required">
                                    <!-- </div> -->
                                </div>  
                            </div>
                             <div class="span6"> 
                                ...
                                <div class="control-group">
                                    ...
                                    <!-- <div class="controls"> -->
                                        <input type="text" name="data[charge]" id="charge" class='form-control'  data-rule-required="true" placeholder="Room charge" value="<?php echo (isset($data['charge']))?$data['charge']:'';?>" required="required">
                                    <!-- </div> -->
                                </div> 
                            </div>  
                        </div>
                        <div class="row-fluid">
                            <div class="span6">
                                ...
                                <div class="control-group">
                                    ...
                                    <!-- <div class="controls"> -->
                                        <input type="text" name="data[deposite]" id="deposite" class='form-control'  data-rule-required="true" placeholder="Room Deposite" value="<?php echo (isset($data['deposite']))?$data['deposite']:'';?>" required="required">
                                    <!-- </div> -->
                                </div>  
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span6">                  
                                  <div class="control-group">
                                    <div class="">
                                     <button type="submit" name="submit" value="submit" class="btn_ad_ed">Add Room</button>
