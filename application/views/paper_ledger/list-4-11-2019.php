...
<div class="row-fluid ">
                ...
                <select data-rule-required="true" class="input-large" name="paper" id="paper" data-rule-required="true" onchange="calc()">
                    ...
                    <?php $tempPaper = array(); 
                        foreach($paper as $k => $v) {
                            $tempPaper[] = $v->paper_name.' ('.$v->gsm.')';
                            echo '<option gsm="'.$v->gsm.'" value="'.$v->id.'">'.$v->paper_name.' ('.$v->gsm.')'.'</option>';
                    }?>
                </select>
            </div>
        </div>
    ...
    <div class="span3">
        <div class="control-group">
            ...
            <div class="controls controls-row">
                <select data-rule-required="true" class="input-large" name="press" id="press" data-rule-required="true">
...
<div class="row-fluid ">
    ...
    <div class="span1">
        <div class="control-group">
            ...
            <div class="controls controls-row">
                <input type="text" name="job_no" id="job_no" placeholder="Job No" class="input-block-level" value="" data-rule-required="true">
            </div>
        </div>
    </div>
    <div class="span2">
                    ...
                    <tbody>
                        ...
                        foreach ($arrData as $key => $data)
                        {
                            ...
                            <tr>
                                ...
                                <?php if ($type == "purchase") { ?>
                                    <td>
                                        <a href="javascript:;" id="stocak_arrival_<?php echo  $data->id; ?>" class="stocak_arrival" 
                                ...
                                <td><?php echo  $data->paper_name.' ('.$data->gsm.')'; ?></td>
