                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span6">
                                <div class="control-group">
                                    ...
                                    <!-- <div class="controls"> -->
                                        <input type="text" name="data[room_type_name]" id="room_type_name" class='form-control'  data-rule-required="true" placeholder="Room Type Name" value="<?php echo (isset($data['room_type_name']))?$data['room_type_name']:'';?>" required="required">
                                    <!-- </div> -->
                                </div> 
                            </div>
                            </div>                        
                            ...
                            <div class="span6">                  
                                  <div class="control-group">
                                    <div class="">
                                     <button type="submit" name="submit" value="submit" class="btn_ad_ed">Add Room Type</button>
