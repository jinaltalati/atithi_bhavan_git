                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span6">    
                                <div class="control-group">
                                    ...
                                    <!-- <div class="controls"> -->
                                        <input type="text" name="data[floor_name]" id="floor_name" class='form-control' data-rule-required="true" placeholder="Floor Name" value="<?php echo $arrData->floor_name?>" required="required">
                                    <!-- </div> -->
                                </div>
                             </div>
                            </div>
                            ...
                            <div class="span6">                  
                                  <div class="control-group">
                                    <div class="">
                                     <button type="submit" name="submit" value="submit" class="btn_ad_ed">Edit Floor</button>
