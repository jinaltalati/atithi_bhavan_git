                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="data[press_name]" id="press_name" class='input-xlarge' data-rule-required="true" placeholder="Press Name" value="<?php echo $arrData->press_name?>">
                                    </div>
                                </div>
                             
                                <div class="form-actions">
                                     <button type="submit" name="submit" value="submit" class="btn btn-primary">Edit Press</button>
