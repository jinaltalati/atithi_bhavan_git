...
<div style="float:left; margin:34px 0 0 100px; color:#fff; letter-spacing:5px; font-size: 20px;">Forgot Password</div>
</div>
<?php 
...
<span style="margin-left: 15px;margin-top: 15px;float: left;width: 100%;font-size: 16px;font-family: 'calibri';">Click on the below link and proceed to change your password.</span> 

     <span style="margin-left: 15px;margin-top: 15px;float: left;width: 100%;font-size: 16px;font-family: 'calibri';">
           <span style='font-weight: bold;float: left;'>
                 <a href='<?php echo base_url() ?>dashboard/getEmail/<?php echo $data['salt']; ?>' style='color: #368DDF;text-decoration: none;border-bottom: 1px solid #67B0D1;'>
                     <?php echo base_url()."dashboard/getEmail/" ?><?php echo $data['salt']; ?>
                 </a>            
           </span>
     </span>    
